...
#ifndef VOUCHSDK_SWIFT_H
#define VOUCHSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="VouchSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSString;
enum VouchErrorReasonObjC : NSInteger;
@class NSCoder;
/// Objective-C compatible error
SWIFT_CLASS("_TtC8VouchSDK14VouchErrorObjC")
@interface VouchErrorObjC : NSError
@property (nonatomic, readonly, copy) NSString * _Nonnull proofId;
@property (nonatomic, readonly) enum VouchErrorReasonObjC reason;
- (nonnull instancetype)initWithProofId:(NSString * _Nonnull)proofId reason:(enum VouchErrorReasonObjC)reason OBJC_DESIGNATED_INITIALIZER;
...
/// Objective-C compatible error reason enum
typedef SWIFT_ENUM(NSInteger, VouchErrorReasonObjC, open) {
...
/// Use this class when calling VouchSDK from Objective-C or Objective-C++ contexts (for example, the React Native bridge modules in packages/react-native-sdk).
...
/// Objective-C compatible success result
SWIFT_CLASS("_TtC8VouchSDK16VouchSuccessObjC")
@interface VouchSuccessObjC : NSObject
@property (nonatomic, readonly, copy) NSString * _Nonnull proofId;
- (nonnull instancetype)initWithProofId:(NSString * _Nonnull)proofId OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
